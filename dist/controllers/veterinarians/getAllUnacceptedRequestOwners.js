...
const getNotAcceptedOwners = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let validatedData;
    try {
        validatedData = yield VS.getNotAcceptedOwnersSchema.validateAsync(req.query);
        if (!validatedData) {
...
exports.default = getNotAcceptedOwners;
