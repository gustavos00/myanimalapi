...
const removeVeterinarian = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let validatedData;
    try {
        validatedData = yield VS.removeVeterinarian.validateAsync(req.body);
        if (!validatedData) {
...
exports.default = removeVeterinarian;
